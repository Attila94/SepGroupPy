import numpy as np
import sepgroupy.garray.p4_array as p4a
from sepgroupy.gfunc.gfuncarray import GFuncArray
...
def tst():
    ...
    from sepgroupy.garray.p4_array import P4Array, meshgrid, u_range, v_range, rotation, translation
